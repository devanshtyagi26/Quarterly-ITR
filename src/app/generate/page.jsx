...
function Generate() {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center w-full h-100% relative gap-6 p-8 bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { label: "Total CGST", val: totals.cgst, color: "text-indigo-600" },
            { label: "Total SGST", val: totals.sgst, color: "text-violet-600" },
          ].map((stat, i) => (
            <Card
              key={i}
        ...
        <Card className="flex-1 border-none shadow-lg ring-1 ring-slate-200 dark:ring-slate-800">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-white dark:bg-slate-900">
              <div className="overflow-x-auto max-h-[500px]">
                <table className="w-full text-sm text-left">
                  <thead className="sticky top-0 bg-slate-50 dark:bg-slate-800 text-slate-500 font-medium border-b border-slate-200 dark:border-slate-700">
                    <tr>
